...
- **Data-integrity observation:** `state.json` records 2026-09-17 `processed` entries for TIP847 (We Study Billionaires), TWIML #777 and Lex Fridman #502, but no corresponding vault files exist in `Podcast Summaries/2026-09-17/`. That gap predates this run (written by a prior/sibling run) and was not repaired here — flagged as a backfill candidate.
